...
public class LinearDynamicModel implements Model {
	...
	@Override
	public double calcLogLikelihood(double[] parameterVector){
	...
	public String getName(){
		return LinearDynamicModel.class.getSimpleName();
	}
